...
import MatrixInput from "../../subScreenComponents/MatrixInput";
...
export default class MatrixDeterminant extends Component {
  constructor(props) {
    super();
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <MatrixInput val="yesss" theme={this.state.theme} />
