...
//Calculators
import {
  Calculate_GravitationalForce_From_UniversalGravitationalConstant_Mass1_Mass2_Distance,
  Calculate_Mass1_From_UniversalGravitationalConstant_Mass2_Distance_GravitationalForce,
  Calculate_Mass2_From_UniversalGravitationalConstant_Mass1_Distance_GravitationalForce,
  Calculate_Distance_From_UniversalGravitationalConstant_Mass1_Mass2_GravitationalForce,
} from "../../calculators/Physics/GravitationalForce";
...
export default class GravitationalForce extends Component {
  constructor(props) {
    super();
  ...
  Calculate_GravitationalForce() {
    if (
      ...
      var Result = Calculate_GravitationalForce_From_UniversalGravitationalConstant_Mass1_Mass2_Distance(
        this.state.G,
        this.state.m1,
        this.state.m2,
        this.state.r,
      ...
      ToastAndroid.show("'Fg' has been calculated.", ToastAndroid.LONG);
    } else if (
      this.state.f != "" &&
      this.state.G != "" &&
      this.state.m2 != "" &&
      ...
      var Result = Calculate_Mass1_From_UniversalGravitationalConstant_Mass2_Distance_GravitationalForce(
        this.state.G,
        this.state.m2,
        this.state.r,
        this.state.f,
      ...
      var Result = Calculate_Mass2_From_UniversalGravitationalConstant_Mass1_Distance_GravitationalForce(
        this.state.G,
        this.state.m1,
        this.state.r,
        this.state.f,
      ...
      var Result = Calculate_Distance_From_UniversalGravitationalConstant_Mass1_Mass2_GravitationalForce(
        this.state.G,
        this.state.m1,
        this.state.m2,
        this.state.f,
      ...
      >
        ...
        >
          ...
          <ScreenButton
            ...
            buttonOnPress={this.Calculate_GravitationalForce.bind(this)}
