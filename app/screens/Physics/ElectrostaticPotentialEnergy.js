...
//Calculators
import {
  Calculate_ElectrostaticPotentialEnergy_From_CoulombsConstant_Charge1_Charge2_Distance,
  Calculate_CoulombsConstant_From_Charge1_Charge2_Distance_ElectrostaticPotentialEnergy,
  Calculate_Charge1_From_CoulombsConstant_Charge2_Distance_ElectrostaticPotentialEnergy,
  Calculate_Charge2_From_CoulombsConstant_Charge1_Distance_ElectrostaticPotentialEnergy,
  Calculate_Distance_From_CoulombsConstant_Charge1_Charge2_ElectrostaticPotentialEnergy,
} from "../../calculators/Physics/ElectrostaticPotentialEnergy";
...
export default class ElectrostaticPotentialEnergy extends Component {
  constructor(props) {
    super();
  ...
  Calculate_ElectrostaticPotentialEnergy() {
    if (
      this.state.k != "" &&
      this.state.q1 != "" &&
      this.state.q2 != "" &&
      ...
      var Result = Calculate_ElectrostaticPotentialEnergy_From_CoulombsConstant_Charge1_Charge2_Distance(
        this.state.k,
        this.state.q1,
        this.state.q2,
        this.state.r,
      ...
      ToastAndroid.show("'Uₑ' has been calculated.", ToastAndroid.LONG);
    } else if (
      this.state.u != "" &&
      this.state.q1 != "" &&
      this.state.q2 != "" &&
      ...
      var Result = Calculate_CoulombsConstant_From_Charge1_Charge2_Distance_ElectrostaticPotentialEnergy(
        this.state.q1,
        this.state.q2,
        this.state.r,
        this.state.u,
      ...
      var Result = Calculate_Charge1_From_CoulombsConstant_Charge2_Distance_ElectrostaticPotentialEnergy(
        this.state.k,
        this.state.q2,
        this.state.r,
        this.state.u,
      ...
      var Result = Calculate_Charge2_From_CoulombsConstant_Charge1_Distance_ElectrostaticPotentialEnergy(
        this.state.k,
        this.state.q1,
        this.state.r,
        this.state.u,
      ...
      var Result = Calculate_Distance_From_CoulombsConstant_Charge1_Charge2_ElectrostaticPotentialEnergy(
        this.state.k,
        this.state.q1,
        this.state.q2,
        this.state.u,
      ...
      >
        ...
        >
          ...
          <ScreenButton
            ...
            buttonOnPress={this.Calculate_ElectrostaticPotentialEnergy.bind(
              this
            )}
